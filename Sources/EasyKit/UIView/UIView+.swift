...
extension UIView {
    ...
    public func makeRoundedWithBorder(radius: CGFloat, color: CGColor, borderWith: CGFloat = 1) {
    ...
    public func dropShadowWithMaskLayer(rounded: CGFloat) {
        let margin = 24
    ...
    public func addShadowWithOpaqueBackground(opacity: Float, radius: CGFloat) {
    ...
    public func makeMoveUpWithFade() {
        self.alpha = 0
